...
class SSNE:
    ...
    # def two_points_crossover_inplace(self, gene1, gene2):
    #     for param1, param2 in zip(gene1.parameters(), gene2.parameters()):
    #         # References to the variable tensors
    #         W1 = param1.data
    #         W2 = param2.data
    #         print(W1.shape[0])
    #         start = random.randint(0, W1.shape[0]-2)
    #         end = random.randint(start+1, W1.shape[0]-1)
    ...
    def epoch(self, pop, fitness_evals):
        ...
        for i, j in zip(unselects[0::2], unselects[1::2]):
            ...
            # self.two_points_crossover_inplace(pop[i], pop[j])
            new_pop.append(copy.deepcopy(pop[i]))
            new_pop.append(copy.deepcopy(pop[j]))
