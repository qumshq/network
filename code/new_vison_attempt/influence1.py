...
class Env:
    ...
    def __init__(self, mainPath):
        ...
        self.maxSeedsNum = 50# 选取的种子节点数量
        # self.networkName = 'power'
        self.networkName = 'GN'
        """
        GN和LFR中的txt文件代表的是128个节点，多条边的无向图
        """
    ...
    def step(self, node):# node是进化步骤中当前Q值最高的点，判断其是否已经在种子集中，否则加入种子集返回加入它的奖励值和状态
        state = None
    ...
    # seeds -> (n+1,d)
    def seeds2input(self,seeds):# 把种子节点转化为DQN的输入形式
