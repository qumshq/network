...
def main():
    ...
    parser.add_argument('--embedding_dim', default=64)# 编码特征数
    ...
    parser.add_argument('--num_batches', default=3000)#300000，训练轮数
    ...
    # +1 是对应着虚拟节点
    parser.add_argument('--num_nodes',type=int, default= 128)# 默认节点个数500
